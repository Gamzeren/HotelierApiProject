...
namespace HotelProject.DataAccessLayer.Migrations
{
    ...
    [Migration("20250807174451_mig_add_booking_city_country")]
    partial class mig_add_booking_city_country
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Contact", b =>
                {
                    ...
                    b.Property<int>("MessageCategoyID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.MessageCategoy", b =>
                {
                    b.Property<int>("MessageCategoyID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MessageCategoyID"), 1L, 1);

                    b.Property<string>("MessageCategoyName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("MessageCategoyID");

                    b.ToTable("MessageCategoys");
                });
            ...
            modelBuilder.Entity("HotelProject.EntityLayer.Concrete.Contact", b =>
                {
                    b.HasOne("HotelProject.EntityLayer.Concrete.MessageCategoy", "MessageCategoy")
                        .WithMany("Contacts")
                        .HasForeignKey("MessageCategoyID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MessageCategoy");
                });
