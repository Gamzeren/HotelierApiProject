...
namespace HotelProject.WebApi.Controllers
{
    ...
    public class MessageCategoryController : ControllerBase
    {
        ...
        [HttpPost]
        public IActionResult AddMessageCategory(MessageCategoy messageCategoy)
        {
            _messageCategoryService.TInsert(messageCategoy);
            return Ok();
        }
        [HttpDelete("{id}")]
        ...
        [HttpPut]
        public IActionResult UpdateMessageCategory(MessageCategoy messageCategoy)
        {
            _messageCategoryService.TUpdate(messageCategoy);
            return Ok();
        }
        [HttpGet("{id}")]
